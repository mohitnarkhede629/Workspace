...
public class Owner {
	...
	public void getCar(int brand,int color) {
      ...
      public void getEngine(int choice) {
		
		if (choice==1) {
			
			this.engine=new Engine1("100 hp","2000 cc","Oil cooling system");
			System.out.println("Engine 1 is fitted in your"+this.car.brand+"car");
	}
		if (choice==2) {
			this.engine=new Engine2("200 hp","3000 cc","oil cooling system");
			System.out.println("Engine 2 is fitted in your " + this.car.brand + " car");
		}	
